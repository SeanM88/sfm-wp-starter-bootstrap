...
function sfm_starter_enqueue_scripts() {
	...
	// Register scripts
	wp_register_script( 'sfm-bootstrap-js-cdn', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js', array('jquery'), '3.3', true ); // Max CDN Bootstrap javascript
